...
const Services = () => {
  return (
    <div>
        ...
        <div class='home-ph1'>
          <div class='row my-5'>
            <div class='col-12 col-sm-6 col-lg-3 col-md-6 d-flex justify-content-center '>
            ...
            <div class='col-12 col-sm-6 col-lg-3 col-md-6 d-flex justify-content-center'>
              ...
              <img src='./Images/Media/pre.jpg' alt='' height={300} width={300} class='home-img7'/>
              <h5 class='home-head7'>Pre-Wedding Photoshoot</h5> 
              </Link>
            </div>
            <div class='col-12 col-sm-6 col-lg-3 col-md-6 d-flex justify-content-center'>
              <Link class='text-decoration-none text-dark' to={'/Wed'}>
              <img src='./Images/Media/wed1.jpg' alt='' height={300} width={300} class='home-img8'/>
