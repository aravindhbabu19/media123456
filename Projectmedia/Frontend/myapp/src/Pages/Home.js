  ...
  return (
    ...
    <div>
        ...
        {/* <div class='home-ph mt-5'>
          ...
          <div class='row'>
            <div class='col'>
              <img src='./Images/Media/mrg.jpg' alt='' height={450} width={370} class='mrg-img '/>
            </div>
            <div class='col'>
            ...
            <div class='col'>
              <img src='./Images/Media/mrg1.jpg' alt='' height={450} width={370} class='mrg1-img '/>
            </div>
          </div>
          <div class='row'>
            <div class='col'>
              <img src='./Images/Media/mrg2.jpg' alt='' height={450} width={370} class='mrg-img1 ms-3 mt-5'/>
            </div>
            <div class='col'>
              <img src='./Images/Media/mrg3.jpg' alt='' height={450} width={370} class='mrg-img1 ms-4 mt-5'/>
            </div>
            <div class='col'>
              <img src='./Images/Media/mrg4.jpg' alt='' height={450} width={370} class='mrg-img1 ms-4 mt-5'/>
            </div>
          </div>
          <div>
